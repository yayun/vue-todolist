...
/***/ function(module, exports, __webpack_require__) {
	...
	new _vue2.default({
	  ...
	  "el": app,
	  components: { todos: _app2.default }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _undo = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    getCurrentActive: function getCurrentActive(id) {
	    ...
	    checkboxClick: function checkboxClick(id, done) {
	  ...
	  computed: {
	    filterTodos: function filterTodos() {
	      ...
	      var filterTodos = (0, _values2.default)(this.$store.getters.todos);
	      if (this.show === "todo") {
	        return filterTodos.filter(function (item) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(10)
	  , $values = __webpack_require__(15)(false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', {
	    ...
	    staticClass: "row row-todo-list"
	  }, [_h('div', {
	    staticClass: "col-md-12"
	  }, [_h('ul', {
	    staticClass: "list-unstyled"
	  }, [_l((filterTodos), function(todo) {
	    return _h('li', [_h('div', {
	      ...
	      staticClass: "checkbox-circle",
	      attrs: {
	        "type": "checkbox"
	      },
	      domProps: {
	        "checked": Array.isArray(todo.done) ? _i(todo.done, null) > -1 : _q(todo.done, true)
	      },
	      on: {
	        "click": function($event) {
	          checkboxClick(todo.id, todo.done)
	        },
	        "change": function($event) {
	          ...
	          if (Array.isArray($$a)) {
	            ...
	            if ($$c) {
	              ...
	              $$i > -1 && (todo.done = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
	            }
	          } else {
	            todo.done = $$c
	          }
	      ...
	      directives: [{
	        name: "show",
	        value: (getCurrentActive(todo.id)),
	        expression: "getCurrentActive(todo.id)"
	      }],
	      staticClass: "pull-right todo-remove",
	      on: {
	        "click": function($event) {
	          deleteTodo(todo.id)
	        }
	  ...
	  return _h('div', {
	    staticClass: "row row-todo-header"
	  }, [_h('h1', ["TODOS"])])
	}}]}
	if (false) {
	  module.hot.accept()
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  return _h('div', [_m(0), " ", _l((todoLists), function(todo, key) {
	    return _h('div', [(todo.active == false) ? _h('div', ["\n      " + _s(todo.text) + "\n    ", _m(1)]) : _e()])
	  })])
	}},staticRenderFns: [function (){with(this) {
	  return _h('p', ["undos:"])
	}},function (){with(this) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
	  addTodo: function addTodo(state, todo) {
	    _vue2.default.set(state.todos, todo.id, todo);
	  },
	  checkboxClick: function checkboxClick(state, key, done) {
	    if (done === true) {
	      _vue2.default.set(state.todos, key, { "text": state.todos[key]["text"], "done": false });
	    } else if (done == false) {
	      _vue2.default.set(state.todos, key, { "text": state.todos[key]["text"], "done": true });
	    }
	  },
	  initTodos: function initTodos(state, todos) {
	    var _iteratorNormalCompletion = true;
	    var _didIteratorError = false;
	    var _iteratorError = undefined;

	    try {
	      for (var _iterator = (0, _getIterator3.default)(todos), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var i = _step.value;

	        _vue2.default.set(state.todos, i.id, i);
	      }
	    } catch (err) {
	  ...
	  deleteTodo: function deleteTodo(state, id) {
	    _vue2.default.delete(state.todos, id);
	  }
	};
	...
	var actions = {
	  deleteTodo: function deleteTodo(_ref, id) {
	    var commit = _ref.commit;

	    var url = "http://127.0.0.1:5000/todo/id";
	    _vue2.default.http.delete(url.replace(/id/g, id)).then(function (response) {
	      commit("deleteTodo", id);
	    });
	  },
	  getTodos: function getTodos(_ref2, fetched) {
	    var commit = _ref2.commit;

	    if (fetched === 1) {
	      return;
	    }
	    _vue2.default.http.post("http://127.0.0.1:5000/todos").then(function (response) {
	  ...
	  add: function add(_ref3, text) {
	    ...
	    _vue2.default.http.post("http://127.0.0.1:5000/todo", { "todo_text": text }).then(function (response) {
	      var todo = { "id": response.body.id, "done": false, "text": text };
	      commit("addTodo", todo);
	    });
	  },
	  checkboxClick: function checkboxClick(_ref4, id, done) {
	    var commit = _ref4.commit;

	    var url = "http://127.0.0.1:5000/todo/id";
	    _vue2.default.http.put(url.replace(/id/g, id)).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(37)(IteratorPrototype, __webpack_require__(44)('iterator'), function(){ return this; });
